...
| 🐧 DEB (Linux Mint/Ubuntu) | [melody_2.0.3_amd64.deb indir](../../releases/download/melody-latest/melody_2.0.3_amd64.deb) |
...
- **Linux Mint/Ubuntu**: `.deb` dosyasına çift tıkla → **Kur** (veya: `sudo apt install ./melody_2.0.3_amd64.deb`)
